...
assert.match(productReadHardening, /to anon, authenticated\s+using \(publicado = true\)/);
assert.match(productReadHardening, /to authenticated\s+using \(\(select public\.is_admin\(\)\)\)/);
